...
// 假数据：调仓记录
const mockRecords = [
  { accountName: '账户 A', fundName: '基金 A', oldRatio: 60, newRatio: 60, status: 'PENDING' },
  { accountName: '账户 B', fundName: '基金 B', oldRatio: 40, newRatio: 40, status: 'PENDING' },
  { accountName: '账户 C', fundName: '基金 C', oldRatio: 50, newRatio: 50, status: 'DONE' },
  { accountName: '账户 D', fundName: '基金 D', oldRatio: 70, newRatio: 70, status: 'FAILED' }
]
...
async function fetchData() {
  ...
  try {
    ...
    const filteredRecords = mockRecords.filter(r => {
      if (filter.value.strategyId && r.fundName !== '基金 A') {
        return false
      }
      return true
    })
...
<!--&lt;!&ndash; src/views/trade-management/Rebalancing.vue &ndash;&gt;-->
<!--<template>-->
<!--  <div class="rebalancing-page">-->
<!--    &lt;!&ndash; 顶部：面包屑 + 标题 + 策略/日期筛选 &ndash;&gt;-->
<!--    <div class="page-header">-->
<!--      <el-breadcrumb separator="/">-->
<!--        <el-breadcrumb-item>策略管理</el-breadcrumb-item>-->
<!--        <el-breadcrumb-item>交易管理</el-breadcrumb-item>-->
